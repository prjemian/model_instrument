...
.. code-block:: bash
    ...
    I Mon-17:14:30 - /path/to/project/src/instrument/core/_logging_setup.py
    I Mon-17:14:30 - /path/to/project/src/instrument/core/aps_dm_setup.py
    W Mon-17:14:30 - APS DM setup file does not exist: '/home/dm/etc/dm.setup.sh'
    I Mon-17:14:30 - /path/to/project/src/instrument/core/debug_setup.py
    I Mon-17:14:30 - /path/to/project/src/instrument/core/functions.py
    I Mon-17:14:30 - /path/to/project/src/instrument/core/mpl_setup.py
    I Mon-17:14:30 - /path/to/project/src/instrument/startup.py
    I Mon-17:14:30 - /path/to/project/src/instrument/core/best_effort.py
    I Mon-17:14:30 - /path/to/project/src/instrument/core/catalog.py
    I Mon-17:14:30 - Databroker catalog: temp
    I Mon-17:14:30 - /path/to/project/src/instrument/core/ophyd_setup.py
    I Mon-17:14:30 - using ophyd control layer: 'pyepics'
    I Mon-17:14:30 - /path/to/project/src/instrument/core/run_engine.py
    I Mon-17:14:30 - /path/to/project/src/instrument/core/epics_setup.py
    I Mon-17:14:30 - /path/to/project/src/instrument/core/metadata.py
    I Mon-17:14:30 - RunEngine metadata saved in directory: /home/user/.config/Bluesky_RunEngine_md
    I Mon-17:14:30 - /path/to/project/src/instrument/core/tests/common.py
